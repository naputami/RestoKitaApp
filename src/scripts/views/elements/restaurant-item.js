            ...
            <article class="item-container">
                <div class="item-media">
                    <div class="item-media__img">
                        <img class="lazyload" src="${CONFIG.BASE_IMAGE_URL}/${this._restaurant.pictureId}" alt="suasana di ${this._restaurant.name}">
                    </div>
                ...
                <div class="item-content">
                    ...
                    <a href="/#/detail/${this._restaurant.id}" class="item-content__readMore" aria-label="read more" id="read-more">Baca selengkapnya&nbsp;<i class="fa-solid fa-angles-right"></i></a>
                </div>
            </article>
        `;
  }
